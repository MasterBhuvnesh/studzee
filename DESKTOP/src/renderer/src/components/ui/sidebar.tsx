      ...
      <div
        ...
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l border-gray-400",
          className
        )}
        style={{ top: 'var(--titlebar-height, 40px)', height: 'calc(100vh - var(--titlebar-height, 40px))' }}
        {...props}
      >
        <div
          data-sidebar="sidebar"
