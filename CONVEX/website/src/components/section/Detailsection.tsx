...
import { MockDevices, MockReading, MockChat } from './mocks';
          ...
          {details.map((detail, index) => (
            ...
            >
              ...
              <div className="flex-1 w-full">
                <div className="relative w-full aspect-4/3 rounded-2xl overflow-hidden  border border-border shadow-2xl bg-card">
                  <detail.mock />
