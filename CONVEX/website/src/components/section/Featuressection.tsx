import { MockTopics, MockQuiz, MockSummary } from './mocks';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-14 w-full">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="w-full relative rounded-2xl md:rounded-[24px] overflow-hidden border border-border bg-card aspect-4/3 transition-colors">
                <feature.mock />
