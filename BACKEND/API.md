      ...
      "data": [
        {
          ...
          "pdfUrl": "https://bucket.s3.region.amazonaws.com/pdfs/introduction-to-typescript.pdf",
          "uploadedAt": "2026-08-10T10:30:00.000Z",
          "size": 1234567
        }
      ],
...
- **Request Body:**
  ```json
  {
    ...
    "imageUrl": "https://bucket.s3.region.amazonaws.com/images/banner.png",
    "sendToAll": true,
...
- **Request Body:**
  ```json
  {
    ...
    "banner": "https://bucket.s3.region.amazonaws.com/assets/banner.png",
    "footer": "This is an automated email from Studzee.",
    "pdfUrls": ["https://bucket.s3.region.amazonaws.com/pdfs/system-design.pdf"]
  }
  ```
